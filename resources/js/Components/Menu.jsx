...
export const Menu = ({ children, user }) => {
    ...
    return (
        <MenuContext.Provider value={{ open, setOpen }}>
            ...
            <Body></Body>
            <div className="px-20 pt-20 container mx-auto">
                {children}
            </div>
...
export const Header = ({ user }) => {
    ...
    return (
        <div className="z-50 fixed w-full bg-[#1A3C1D]" >
...
export const Body = ({ children }) => {
    ...
    return (
        <>
            ...
            >
                {/* Menu desplegable  */}
                <nav className='navbar flex flex-col flex-none fixed dark:bg-black w-full sm:max-w-80 rounded-r-lg style-menu' >
                    ...
                    <div className='pl-4 pr-6 content-nav mb-5'>
                        <div className='flex gap-2 items-center text-white '>
                            ...
                            <p className='text-left text-lg w-2/4'>Jael Pineda Quiroz</p>
                        </div>
                    </div>
                    ...
                    <div className='pl-4 pr-6 content-nav mb-5'>
                        ...
                        <MenuLink
                            href={route('canalizar')}
                            active={route().current('canalizar')}
                        >
